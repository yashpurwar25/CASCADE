...
# --- Portfolio (for cross-project heatmap) --------------------------------
PORTFOLIO_PROJECTS = [
    {"name": "Riverside Tower",      "shares_vendor": "GlobalSteel_Co", "shares_crew": "Structural Crew A"},
    {"name": "Harbor View Complex",  "shares_vendor": "GlobalSteel_Co", "shares_crew": None},
    {"name": "Midtown Retail Hub",   "shares_vendor": None,             "shares_crew": "HVAC Crew A"},
    {"name": "Lakeside Residences",  "shares_vendor": None,             "shares_crew": None},
    {"name": "Airport Logistics Ctr","shares_vendor": "HVAC_Partners_Inc", "shares_crew": None},
]